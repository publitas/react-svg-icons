...
var Button = React.createClass({
  ...
  style: function style() {
    ...
    return assign({}, buttonStyle, this.state.hover ? hoverStyle : normalStyle);
  },
...
var Example = React.createClass({
  ...
  textStyle: function textStyle(styl) {
    return assign({}, styl, {
      color: this.state.color
    });
  },

  renderGithubIcon: function renderGithubIcon(params) {
    return React.createElement(Icon, { name: 'github',
      style: assign({}, buttonIconStyle, { height: 20, marginTop: -10 }),
      viewBox: '0 0 1024 1024',
      color: params.hover ? _style.background : this.state.color });
  },

  renderNpmIcon: function renderNpmIcon(params) {
    var color = params.hover ? _style.background : this.state.color;

    return React.createElement(Icon, { name: 'npm',
      style: assign({}, buttonIconStyle, { height: 12, marginTop: -6 }),
      height: '16',
      color: function (_, orig) {
        return orig === '#FFF' ? 'none' : color;
      } });
  },
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'h1',
          { style: this.textStyle(headerStyle) },
          'React SVG Icons'
        ),
      ...
      React.createElement(
        ...
        React.createElement(
          'ul',
          { style: this.textStyle(featureList.style) },
          React.createElement(
            'li',
            null,
            'Converts SVGs into configurable React components'
          ),
          React.createElement(
            'li',
            null,
            'Inlines all SVGs in your asset directory'
          ),
          React.createElement(
            'li',
            null,
          ...
          React.createElement(
            'li',
            null,
            'Browserify support only, at the moment'
          )
        ),
        React.createElement(
          'h2',
          { style: this.textStyle(subHeaderStyle) },
          'Learn More:'
        ),
        React.createElement(Button, { href: 'https://github.com/publitas/react-svg-icons',
          color: this.state.color,
          renderIcon: this.renderGithubIcon,
          text: 'GitHub' }),
        React.createElement(Button, { href: 'https://www.npmjs.com/package/react-svg-icons',
          color: this.state.color,
...
(function (err, svgIcons) {
    ...
    icons = svgIcons;
})(null,{ github:function anonymous(params) {
...
return React.createElement('svg', _extends({}, params, { viewBox: '0 0 18 7' }), React.createElement('path', {
    fill: evalColor('fill', '#CB3837'),
    d: 'M0 0h18v6H9v1H5V6H0V0zm1 5h2V2h1v3h1V1H1v4zm5-4v5h2V5h2V1H6zm2 1h1v2H8V2zm3-1v4h2V2h1v3h1V2h1v3h1V1h-6z'
}), React.createElement('path', {
    fill: evalColor('fill', '#FFF'),
    d: 'M1 5h2V2h1v3h1V1H1M6 1v5h2V5h2V1H6zm3 3H8V2h1v2zM11 1v4h2V2h1v3h1V2h1v3h1V1'
}));;
},
  "react-icon":function anonymous(params) {
var evalColor = function () {
    if (typeof params.color === 'function') {
        return params.color;
    } else {
...
return React.createElement('svg', _extends({}, params, { viewBox: '0 0 64 64' }), React.createElement('title', null, 'react-icon'), React.createElement('g', {
    ...
    stroke: evalColor('stroke', '#979797'),
    strokeWidth: '2',
    cx: '33',
    cy: '31',
    rx: '28',
